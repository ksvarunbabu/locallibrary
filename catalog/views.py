...
class BookCreate(CreateView):
    ...
    template_name = 'catalog/book_form.html'  # Path to your form template

    def form_valid(self, form):
        messages.success(self.request, "The book has been added successfully!")
...
class BookUpdate(UpdateView):
    ...
    def form_valid(self, form):
        messages.success(self.request, "The book has been updated successfully!")
        return super().form_valid(form)
...
def book_delete(request, pk):
    ...
    try:
        ...
        messages.error(request, book.title + " cannot be deleted.")
